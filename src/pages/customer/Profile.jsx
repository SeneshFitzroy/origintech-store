  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-main)', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ padding: '3rem 1rem 5rem', maxWidth: 720 }}>
        ...
        {/* Hero banner */}
        <div style={{ background: 'linear-gradient(135deg,var(--premium-navy),#0F2040,#1a3557)', borderRadius: 24, padding: '2.5rem 2rem', marginBottom: '2.5rem', color: '#fff', display: 'flex', alignItems: 'center', gap: '2rem', flexWrap: 'wrap' }}>
          {/* Avatar */}
          <div style={{ position: 'relative' }}>
